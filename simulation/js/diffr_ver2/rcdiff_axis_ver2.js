...
function mainswt() {
    ...
    if (bttn == "Off") {
        ...
        document.getElementById("resistor").value='0';
         ...
         document.getElementById("capacitor").value='0';
         document.getElementById("captr").value='0';
        document.getElementById("sqrcrv").disabled = true;
        document.getElementById("tridop").disabled = true;

    }
    else {
        document.getElementById("onff").value = "Off";

        document.getElementById("sqrcrv").disabled = false;
        document.getElementById("triop").disabled = true;
