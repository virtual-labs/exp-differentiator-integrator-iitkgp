...
function trif() {
    ...
    for (i = 0; i < 101; i++) {
        ...
        var p = 2 * 3.1415 * fo * x[i] + phase * 3.1415 / 180;
        var z = Math.sin(p);
        y1[i] = (parseFloat(Vp / 3) * Math.asin(0 - z));//-Math.sign(Vp *Math.sin(2 * 3.1415 * fo * x[i] + phase * 3.1415 / 180));
    }
    for (i = 101; i < 202; i++) {
        x[i] = (tstart + i * dt).toPrecision(6);
        var r = 2 * 3.1415 * fo * x[i] + phase * 3.1415 / 180;
        var s = Math.sin(r);
        y2[i] = (parseFloat(Vp / 3) * Math.asin(s));// Math.sign(Vp *Math.sin(2 * 3.1415 * fo * x[i] + phase * 3.1415 / 180));
    }
    for (i = 0; i < 202; i++) {
